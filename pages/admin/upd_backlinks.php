<div class="container">
  <h3 class="dmn__main__title text--center"><b>Edit Backlink: <?=$backlinksMod['LINK_NAME']?></b></h3><br />
  <div class="modal-body">
    <div class="well bs-component">
      <!-- inizio grigio -->
      <form name="form_backlinks" id="form_backlinks" method="post" enctype="multipart/form-data"
        action="javascript:fUpdateBacklinks()">
        ...
        <div class="form-group">
          <div class="dmn__backlinks">
            <div class="dmn__backlinks__left">
              <label for="LINK_NAME" class="form-control-label">Link Name<a style="cursor:normal; text-decoration:none;"
                  title="">*</a></label>
              <input type="text" class="form-control" data-provide="markdown" id="LINK_NAME" name="LINK_NAME"
                placeholder="Link Name" maxlength="100" value="<?=$backlinksMod['LINK_NAME']?>" required />
              <label for="CONTACT_NAME" class="form-control-label">Contact Name<a
                  style="cursor:normal; text-decoration:none;" title=""></a></label>
              <input type="text" class="form-control" data-provide="markdown" id="CONTACT_NAME" name="CONTACT_NAME"
                placeholder="Contact Name" maxlength="100" value="<?=$backlinksMod['CONTACT_NAME']?>" />
              <label for="CONTACT_EMAIL" class="form-control-label">Contect Email<a
                  style="cursor:normal; text-decoration:none;" title=""></a></label>
              <input type="email" class="form-control" data-provide="markdown" id="CONTACT_EMAIL" name="CONTACT_EMAIL"
                placeholder="Contact Email" maxlength="100" value="<?=$backlinksMod['CONTACT_EMAIL']?>" />
              <label for="COUNTY" class="form-control-label">Country<a style="cursor:normal; text-decoration:none;"
                  title=""></a></label>
              <input type="text" class="form-control" data-provide="markdown" id="COUNTRY" name="COUNTRY"
                placeholder="Country" maxlength="50" value="<?=$backlinksMod['COUNTRY']?>" />
              ...
              <input type="text" class="form-control" data-provide="markdown" id="LINK" name="LINK"
                placeholder="Link to the Page include http://" maxlength="150" value="<?=$backlinksMod['LINK']?>" />
              <br /><br />
            </div>
            <div class="dmn__backlinks__right">
              ...
              <select name="TOP_LINK" id="TOP_LINK" class="form-control">
                ...
                <option value="1" <?php if ($backlinksMod['TOP_LINK'] == 1) {echo('selected="selected"');}?>>Top
                </option>
              </select>
              <label for="titolo_evento" class="form-control-label">Backlink Description<a
                  style="cursor:normal; text-decoration:none;" title="">*</a></label>
              <textarea type="text" class="form-control" data-provide="markdown" id="DESCRIPTION" name="DESCRIPTION"
                placeholder="Backlink Description" rows="8" required><?=$backlinksMod['DESCRIPTION']?></textarea>
              <br /><br />
            </div>
          </div>
          <div class="dmn__backlinks__imgcontainer">
            <div class="dmn__backlinks__imgcontainer__element">
              Change Backlink's Image (only JPG max dimension 1 mB):
              <img src="<?=$root?>imgs/backlinks/BKL_<?=$backlinksMod['ID']?>.jpg?<?=rand(1,32000)?>"
  ...
  <div>
    ...
    <script>
      ...
      function fUpdateBacklinks() {

        var params = {
          page: "admin",
          step: "UpdateBacklinks",
          IDT: "<?=$backlinksMod['ID']?>",
