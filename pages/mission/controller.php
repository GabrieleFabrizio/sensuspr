...
if (preg_match("/controller.php/",$_SERVER['PHP_SELF'])) {
  ...
  die();
    ...
    case "index":
        ...
        global $theme ;
        $theme['view'] = 'Y';
        $theme['height'] = "0.5"; // 1 or .5 for half size window
        $theme['video'] = "videoBG/sparks.mp4";
        $theme['img'] = $root."img/bcktest.jpg";
        $theme['mainQuote'] = "Mission & Vision";
        $theme['subQuote'] = "Illuminating the Path Forward";
        $theme['contLink'] = "";
        $theme['logoColor'] = "W"; // put W for white
        $theme['textColor'] = "W";
        $theme['socialColor'] = "W";
        break;
