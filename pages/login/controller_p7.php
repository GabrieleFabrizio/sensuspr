...
if (preg_match("/controller.php/",$_SERVER['PHP_SELF'])) {
  ...
  global $meta;
    ...
    case "index":
          ...
          //meta elements
          if ($_SESSION['authorized']=="true"){ 
            $meta->pageTitle ="Kitesurf Culture User profile";
          } else{
            $meta->pageTitle ="Kitesurf Culture Team Login";
          }
          $meta->pageMetaDescription = "Kitesurf Culture Team Login";
          $meta->pageMetaKeywords = "Kitesurf Culture Team Login";
